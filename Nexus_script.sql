...
INSERT INTO TB_CHATTING VALUES(SEQ_CHATTING.NEXTVAL,1,'ㅎㅇㅎㅇ',NULL,NULL,1,SYSDATE);
INSERT INTO TB_CHATTING VALUES(SEQ_CHATTING.NEXTVAL,1,'ㅋㅋㅋㅋ',NULL,NULL,2,SYSDATE);
INSERT INTO TB_CHATTING VALUES(SEQ_CHATTING.NEXTVAL,2,'철현의 코딩일지..',NULL,NULL,3,SYSDATE);
--INSERT INTO TB_CHATTING VALUES(SEQ_CHATTING.NEXTVAL,1,'철현의 코딩일지..',NULL,NULL,4,SYSDATE);
...
COMMENT ON COLUMN TB_REPOSITORY.USER_NO IS '유저 번호';
COMMENT ON COLUMN TB_REPOSITORY.USER_NAME IS 'REPO소유자명';
COMMENT ON COLUMN TB_REPOSITORY.REPO_NAME IS 'REPO 이름';
COMMENT ON COLUMN TB_REPOSITORY.REPO_CONTENT IS 'REPO 내용';
COMMENT ON COLUMN TB_REPOSITORY.REPO_STATUS IS 'REPO 공개 상태';
COMMENT ON COLUMN TB_REPOSITORY.STATUS IS '삭제여부';
