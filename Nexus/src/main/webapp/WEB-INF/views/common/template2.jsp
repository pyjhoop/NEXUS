				...
				<nav
					...
					<div class="navbar-nav-right d-flex align-items-center"
						...
						<ul class="navbar-nav flex-row align-items-center ms-auto">
							...
							<li class="nav-item">
								<button type="button" class="btn btn-outline-primary" id="enroll" style="visibility: hidden;">뉴스작성</button>
							</li>
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								...
								href="javascript:void(0);" data-bs-toggle="dropdown" id="dropdownToggle">
