...
//         @RequestParam(required = false) String assignee,@RequestParam(required = false) String milestone, @RequestParam(required = false)String label, HttpSession session, int ino) {
//
//      String repository = (String) session.getAttribute("repository");
//
//      String token = ((Member) session.getAttribute("loginUser")).getToken();
...
//           milestoneObject.put("number", milestone); // Update the milestone title
//           requestBody.put("milestone", milestoneObject); // Update the milestone
//       }
//      
...
//   }
   ...
   public String updateIssue(@RequestParam String title, @RequestParam(required = false) String body,
       ...
       String path = repository + "/issues";
       String response = iService.gitPatchMethod(path, session, title, body, ino);
